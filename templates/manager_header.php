...
<head>
    ...
    <title><?php echo isset($page_title) ? $page_title . ' - SMD Manager' : 'SMD Manager'; ?></title>
...
<body>
    <div class="dashboard-container">
        <aside class="sidebar">
            ...
            <nav>
                <ul>
                    <li><a href="manager_dashboard.php" <?php echo ($page == 'manager_dashboard.php') ? 'class="active"' : ''; ?>>Dashboard</a></li>
                    <li><a href="add_job.php" <?php echo ($page == 'add_job') ? 'class="active"' : ''; ?>>Job Management</a></li>
